...
happy2018$color <- v_color[Matrix::invPerm(
  p = order(
    x = happy2018$Score
  )
)]
...
cor_happy_2019 <- subset(happy2018, select = -c(1, 2, 10))
...
options(repr.plot.width = 12, repr.plot.height = 10)
top_gdp <- happy2018[order(-happy2018$GDP.per.capita),]
...
options(repr.plot.width = 12, repr.plot.height = 10)
top_social <- happy2018[order(-happy2018$Social.support),]
...
options(repr.plot.width = 12, repr.plot.height = 10)
top_lifeexpectancy <- happy2018[order(-happy2018$Healthy.life.expectancy),]
...
options(repr.plot.width = 12, repr.plot.height = 10)
top_free <- happy2018[order(-happy2018$Freedom.to.make.life.choices),]
...
options(repr.plot.width = 12, repr.plot.height = 10)
top_gen <- happy2018[order(-happy2018$Generosity),]
...
options(repr.plot.width = 12, repr.plot.height = 10)
top_trust <- happy2018[order(-happy2018$Perceptions.of.corruption),]
